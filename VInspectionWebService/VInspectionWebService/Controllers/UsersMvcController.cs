...
namespace VInspectionWebService.Controllers
{
    public class UsersMvcController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdUsuario,Nombre,Cuenta,Contrasena,Perfil,Area,Buscador")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdUsuario,Nombre,Cuenta,Contrasena,Perfil,Area,Buscador")] User user)
        {
            if (ModelState.IsValid)
            {
